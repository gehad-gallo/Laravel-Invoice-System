  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        ...
        <li class="menu-item">
          <a href="https://pixinvent.com/demo/vuexy-html-bootstrap-admin-template/html/horizontal-menu-template" class="menu-link" target="_blank">
    ...
    <li class="menu-item">
      <a href="https://pixinvent.com/demo/vuexy-html-bootstrap-admin-template/documentation/" target="_blank" class="menu-link">
...
<h4 class="fw-semibold mb-4">Add order</h4>
 ...
 <div class="col-12">
    <div class="card">
      <div class="card-body">
        ...
        <form id="formValidationExamples" class="row g-3" method="POST" action="{{route('add.new.order')}}">
          @csrf
          
          <div class="col-md-6">
            <label class="form-label" for="formValidationSelect2">Select Client</label>
            ...
            <div class="col-md-4">
              <label class="form-label" for="multicol-birthdate">Date</label>
              <input type="text" class="form-control dob-picker" name="date" placeholder="YYYY-MM-DD" />
            </div>
            <div class="col-md-3">
