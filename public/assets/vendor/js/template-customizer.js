!function() {
            ...
            t.exports = function(t) {
                ...
                return e.toString = function() {
                    return this.map((function(e) {
                        var s = ""
                          , i = void 0 !== e[5];
                        return e[4] && (s += "@supports (".concat(e[4], ") {")),
                        e[2] && (s += "@media ".concat(e[2], " {")),
                        i && (s += "@layer".concat(e[5].length > 0 ? " ".concat(e[5]) : "", " {")),
                        s += t(e),
                        i && (s += "}"),
                        e[2] && (s += "}"),
                        e[4] && (s += "}"),
                ...
                e.i = function(t, s, i, a, o) {
                    ...
                    for (var c = 0; c < t.length; c++) {
                        var u = [].concat(t[c]);
                        i && n[u[0]] || (void 0 !== o && (void 0 === u[5] || (u[1] = "@layer".concat(u[5].length > 0 ? " ".concat(u[5]) : "", " {").concat(u[1], "}")),
                        u[5] = o),
        ...
        3379: function(t) {
            ...
            t.exports = function(t, a) {
                ...
                return function(t) {
                    ...
                    for (var r = i(t, a), c = 0; c < o.length; c++) {
                        var u = s(o[c]);
                ...
                return {
                    update: function(s) {
                        !function(t, e, s) {
                            ...
                            a && (i += "@layer".concat(s.layer.length > 0 ? " ".concat(s.layer) : "", " {")),
                            i += s.css,
                            a && (i += "}"),
                            s.media && (i += "}"),
                            s.supports && (i += "}");
    ...
    !function() {
        ...
        var b = ["rtl", "style", "layoutType", "layoutMenuFlipped", "showDropdownOnHover", "layoutNavbarFixed", "layoutFooterFixed", "themes"]
          , _ = ["light", "dark"]
          , x = document.documentElement.classList
          , w = document.getElementsByTagName("HTML")[0].getAttribute("data-theme") || 0
          , S = x.contains("dark-style") ? "dark" : "light"
          , z = "rtl" === document.documentElement.getAttribute("dir")
          , F = !!x.contains("layout-menu-collapsed")
          , k = !!x.contains("layout-menu-flipped")
          , C = !!x.contains("layout-navbar-fixed")
          , A = !!x.contains("layout-footer-fixed")
          , T = x.contains("layout-menu-offcanvas") ? "static-offcanvas" : x.contains("layout-menu-fixed") ? "fixed" : x.contains("layout-menu-fixed-offcanvas") ? "fixed-offcanvas" : "static"
          , N = function() {
            function t(e) {
                var s = e.cssPath
                  , i = e.themesPath
                ...
                !this._ssr) {
                    ...
                    this.settings.controls = n || b,
                    this.settings.defaultTextDir = "rtl" === l || z,
                    this.settings.defaultLayoutType = r || T,
                    this.settings.defaultMenuCollapsed = void 0 !== c ? c : F,
                    this.settings.defaultMenuFlipped = void 0 !== u ? u : k,
                    this.settings.defaultShowDropdownOnHover = void 0 !== d ? d : void 0,
                    this.settings.defaultNavbarFixed = void 0 !== h ? h : C,
                    this.settings.defaultFooterFixed = void 0 !== p ? p : A,
                    this.settings.availableThemes = f || t.THEMES,
                    this.settings.defaultTheme = this._getDefaultTheme(void 0 !== g ? g : w),
                    this.settings.styles = m || _,
                    this.settings.defaultStyle = y || S,
                    this.settings.lang = N || "en",
                    this.pathResolver = v || function(t) {
                        return t
                    }
                    ,
                    this.settings.styles.length < 2) {
                        var E = this.settings.controls.indexOf("style");
                        -1 !== E && (this.settings.controls = this.settings.controls.slice(0, E).concat(this.settings.controls.slice(E + 1)))
                    }
                    this.settings.onSettingsChange = "function" == typeof x ? x : function() {}
                    ,
                    this._loadSettings(),
                    this._listeners = [],
                    this._controls = {},
            ...
            s = [{
                ...
                value: function(t) {
                    ...
                    if (this._hasControls("themes")) {
                        ...
                        if (i) {
                            ...
                            var a = this.pathResolver(this.settings.themesPath + this.settings.cssFilenamePattern.replace("%name%", t + ("light" !== this.settings.style ? "-".concat(this.settings.style) : "")));
                            this._loadStylesheets(g({}, a, document.querySelector(".template-customizer-theme-css")), s || function() {}
                            ),
                ...
                value: function(e) {
                    ...
                    if (e !== this.settings.lang || i) {
                        ...
                        for (var o = a.themes || {}, n = this.container.querySelectorAll(".template-customizer-theme-item") || [], l = 0, r = n.length; l < r; l++) {
                            var c = n[l].querySelector('input[type="radio"]').value;
                            n[l].querySelector(".template-customizer-theme-name").textContent = o[c] || this._getThemeByName(c).title
                        }
                ...
                value: function() {
                    if (!this._ssr) {
                        ...
                        s && t && "fixed" == this.settings.layoutType && (this._controls.layoutNavbarFixed.setAttribute("disabled", "disabled"),
                        this._controls.layoutNavbarFixedW.classList.add("disabled"))),
                        ...
                        !e && "fixed" == this.settings.layoutType && this._hasControls("layoutNavbarFixed") && (this._controls.layoutNavbarFixed.setAttribute("disabled", "disabled"),
                        this._controls.layoutNavbarFixedW.classList.add("disabled")),
                        this._controls.layoutType && (e || s ? this._controls.layoutType.removeAttribute("disabled") : this._controls.layoutType.setAttribute("disabled", "disabled"))
                    }
                }
            }, {
                ...
                key: "_loadSettings",
                value: function() {
                    var t, e = this._getSetting("Rtl"), s = this._getSetting("Style"), i = this._getSetting("LayoutCollapsed"), a = this._getSetting("LayoutMenuFlipped"), o = this._getSetting("ShowDropdownOnHover"), n = this._getSetting("FixedNavbar"), l = this._getSetting("FixedFooter"), r = this._getSetting("LayoutType");
                    ...
                    this.settings.layoutMenuFlipped = "" !== a ? "true" === a : this.settings.defaultMenuFlipped,
                    this.settings.showDropdownOnHover = "" !== o ? "true" === o : this.settings.defaultShowDropdownOnHover,
                    ...
                    this._hasControls("style") || (this.settings.style = x.contains("dark-style") ? "dark" : "light"),
                ...
                value: function() {
                    ...
                    this._cleanup(),
                    this.container = this._getElementFromString(f);
                    ...
                    var o = this.container.querySelector(".template-customizer-close-btn")
                      , n = function() {
                    ...
                    if (this._hasControls("themes")) {
                        ...
                        m.querySelector('input[value="'.concat(this.settings.theme.name, '"]')).setAttribute("checked", "checked");
                        var y = function(e) {
                        ...
                        this._listeners.push([m, "change", y])
                    } else
                    ...
                    if (this._hasControls("layoutType layoutNavbarFixed layoutFooterFixed layoutMenuFlipped showDropdownOnHover", !0)) {
                        var b = this.container.querySelector(".template-customizer-layoutType");
                        if (this._hasControls("layoutType")) {
                            this._controls.layoutType = b.querySelector(".template-customizer-layouts-options"),
                            ...
                            this._controls.layoutType.addEventListener("change", _),
                            this._listeners.push([this._controls.layoutType, "change", _])
                        } else
                        ...
                        this._hasControls("showDropdownOnHover")) {
                            ...
                            this._controls.showDropdownOnHover.addEventListener("change", x),
                            this._listeners.push([this._controls.showDropdownOnHover, "change", x])
                        } else
                        ...
                        this._hasControls("layoutFooterFixed")) {
                            ...
                            this._controls.layoutFooterFixed.addEventListener("change", S),
                            this._listeners.push([this._controls.layoutFooterFixed, "change", S])
                        } else
        ...
        s.parentNode.removeChild(s)
                ...
                value: function(t, e) {
                    ...
                    function o(t, e, s) {
                        ...
                        var a, o = "sheet"in i ? "sheet" : "styleSheet", n = "sheet"in i ? "cssRules" : "rules", l = setTimeout((function() {
                            clearInterval(a),
                            clearTimeout(l),
                        ...
                        a = setInterval((function() {
                            try {
                                i[o] && i[o][n].length && (clearInterval(a),
                                clearTimeout(l),
